...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
 ...
 <?php
  ...
  <div class="dropdowna">
  <button class="dropbtna" onclick="myFunction()">Dropdown
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-contenta" id="myDropdowna">
    <a href="#">Link 1</a>
    <a href="#">Link 2</a>
    <a href="#">Link 3</a>
  </div>
  ...
  <div class="dropdown-contenta" id="myDropdowna">
    ...
    <div class="site-section mt-5">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="row">
          <div class="col-lg-4 mb-5 col-md-6 offset-xs-3">
            ...
            <div class="wine_v_1 text-center pb-4">
              ...
              <div class="wine-actions">
                ...
                <span class="descripcion d-block">vino suave y delicisi</span>
...
window.onclick = function(e) {
  ...
  var myDropdowna = document.getElementById("myDropdowna");
    if (myDropdowna.classList.contains('showa')) {
      myDropdowna.classList.remove('showa');
    }
  }
}
</script>
