...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  ?>
    ...
    <div class="owl-carousel hero-slide owl-style">
      <div class="intro-section container" style="background-image: url('images/PS4.png');">
      ...
      <div class="intro-section container" style="background-image: url('images/img_2.jpg');">
        <div class="row justify-content-center text-center align-items-center">
          <div class="col-md-8">
          </div>
        </div>
      ...
      <div class="intro-section container" style="background-image: url('images/sony01.jpg');">
        <div class="row justify-content-center text-center align-items-center">
          <div class="col-md-8">
          </div>
        </div>
      ...
      <div class="intro-section container" style="background-image: url('images/xbox02.jpg');">
        <div class="row justify-content-center text-center align-items-center">
          <div class="col-md-8">
          </div>
        </div>
    ...
    <div class="hero-2" style="background-image: url('images/SWTOR.jpg');">
     <div class="container">
        <div class="row justify-content-center text-center align-items-center">
          <div class="col-md-8">
            <span class="sub-title">Catalogos</span>
